...
object Backend {
    ...
    fun initialize(applicationContext: Context) : Backend {
        try {
            Amplify.addPlugin(AWSCognitoAuthPlugin())   //Amplify 身份验证库
        ...
        //https://aws.amazon.com/cn/getting-started/hands-on/build-android-app-amplify/module-three/
        //func内，身份验证 begin
    ...
    fun signIn(callingActivity: Activity) {
        ...
        Amplify.Auth.signInWithWebUI(
            ...
            { error: AuthException -> Log.e(TAG, error.toString()) }    //也是用amplifyframework.auth
        )
    }
    //在运行时触发身份验证 end
